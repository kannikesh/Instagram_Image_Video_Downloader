        ...
        if (TextUtils.isEmpty(postUrl)) {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    JSONObject o2 = null;
                    try {
                        o2 = o.getJSONObject("shortcode_media");
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    try {
                        finalVideoUrl[0] = o2.getString("video_url");
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    Log.d("finalURL", finalVideoUrl[0]);
                    UtilsMain.downloadVideo(finalVideoUrl[0], UtilsMain.RootDirectoryInstagramVideo, context, System.currentTimeMillis() + ".mp4");
        ...
        if (TextUtils.isEmpty(postUrl)) {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    Log.d("finalURL", finalVideoUrl[0]);
                    UtilsMain.downloadVideo(finalVideoUrl[0], "/Insta Video Downloader/" + directory + "/", context, System.currentTimeMillis() + ".mp4");
